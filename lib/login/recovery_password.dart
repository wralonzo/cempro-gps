  ...
  Future<String> savePassword(String usuario, String newPassword) async{
    ...
    if(respuesta.statusCode == 200){
      if(mensaje == 'Clave actualizada existosamente!'){
        _showDialog(context, "Clave Actualizada!", mensaje+'... Para ver los cambios cierre sesión e inicie nuevamente.');
      }else{
                      ...
                      children: <Widget>[
                        ...
                        TextField(
                          decoration: InputDecoration(
                            ...
                            helperStyle: TextStyle(color: Colors.green, fontSize: 13),
                              suffixStyle: const TextStyle(color: Colors.green)
                          ),
