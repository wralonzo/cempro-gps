...
class _MyHomePageState extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
    final emailField = TextField(
      ...
      style: TextStyle(fontFamily: 'Montserrat', color: Colors.black, fontSize: 25),
      decoration: InputDecoration(
          ...
          // hintText: "Clave",
          hintStyle: TextStyle(fontFamily: 'Montserrat', color: Colors.black, fontSize: 25),
    ...
    final loginButon = Material(
      ...
      child: MaterialButton(
        ...
        child: Text("Ingresar",
            textAlign: TextAlign.center,
            style: TextStyle(color: Colors.white, fontSize: 25, fontWeight: FontWeight.bold, fontFamily: 'Montserrat')),
                    ...
                    SizedBox(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(' Progeso', style: TextStyle(color: Colors.white, fontSize: 50)),

                        ],
                      ),
                    ),
                    SizedBox(height: 60.0),
                    Text('BIENVENIDO',textAlign: TextAlign.center, style: TextStyle(fontSize: 50, color: Colors.white)),
                      ...
                      children: [
                        ...
                        InkWell(
                          child: Text('Mostrar Clave',
                              textAlign: TextAlign.center,
                              style: TextStyle(color: Colors.white, fontSize: 17, fontWeight: FontWeight.bold, fontFamily: 'Montserrat')),
                          onTap: () {
                            setState(() {
                              if(verpass == true){
                                verpass = false;
